...
#ifndef HAL_RADIO_DEFAULT_PREAMBLE_LEN
#define HAL_RADIO_DEFAULT_PREAMBLE_LEN (3)
#endif /* HAL_RADIO_DEFAULT_PREAMBLE_LEN */
...
typedef enum {
    HAL_RADIO_BITRATE_1_2 = 1,
    HAL_RADIO_BITRATE_2_4,
    HAL_RADIO_BITRATE_4_8,
    HAL_RADIO_BITRATE_9_6,
    HAL_RADIO_BITRATE_12_5,
    HAL_RADIO_BITRATE_19_2,
    HAL_RADIO_BITRATE_25,
    HAL_RADIO_BITRATE_38_4,
    HAL_RADIO_BITRATE_50,
    HAL_RADIO_BITRATE_76_8,
    HAL_RADIO_BITRATE_100,
    HAL_RADIO_BITRATE_115_2,
